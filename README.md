# Telegram-бот для D&D клубов — ваш эксперт по автоматизации
Привет! Меня зовут Валерия, я специализируюсь на разработке Telegram-ботов для различных целей. 

Данный бот был создан для D&D-клуба в Черногории, для записи на мероприятие и с удобной админ-панелью для регистрации новых мероприятий. Протестировать: https://t.me/dnd_montenegro_bot
